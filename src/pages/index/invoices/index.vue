  ...
  <main class="w-full h-full">
    <div class="w-full h-full flex flex-col items-start justify-start">
      <div class="flex justify-between w-full gap-9 mb-2">
        <div class="w-2/3 lg:max-w-[70%] flex gap-2">
          ...
          <Input
            v-model="agentThreads"
            placeholder="每个代理的线程数"
            type="number"
            min="1"
          />
          ...
          <div class="flex flex-col h-full w-full" style="padding-top: 10px">
            <label style="font-size: 14px; color: #666">
              <input type="checkbox" v-model="randomUse" />
              {{ t("随机使用") }}
            </label>
          </div>
          <div class="flex flex-col h-full w-full" style="padding-top: 10px">
